...
<section class="page-hero">
    <div class="container">
        <p class="section-kicker">@lang('messages.skills')</p>
        <h1>@lang('messages.skills_title')</h1>
...
<section class="site-section">
    <div class="container skills-grid">
        ...
        <section class="skill-section">
            <h2>@lang('messages.frontend_title')</h2>
            <ul>
                <li>JavaScript</li>
                <li>jQuery</li>
                <li>CSS 3</li>
            ...
            <h3>@lang('messages.editor_title')</h3>
            <ul>
                <li>Visual Studio Code</li>
            </ul>

            <h3>@lang('messages.markup_title')</h3>
            <ul>
                <li>HTML 5</li>
            </ul>

            <h3>@lang('messages.ide_title')</h3>
            <ul>
        ...
        <section class="skill-section skill-section-dark">
            <h2>@lang('messages.database_title')</h2>
            <ul>
                <li>MySQL</li>
            ...
            <h3>@lang('messages.version_control_title')</h3>
            <ul>
                <li>Git</li>
                <li>GitLab</li>
                <li>Bitbucket</li>
            ...
            <h3>@lang('messages.api_testing_title')</h3>
            <ul>
                <li>Postman</li>
            </ul>

            <h3>@lang('messages.agile_title')</h3>
            <ul>
                <li>Scrum</li>
